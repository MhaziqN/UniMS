...
def open():
    global My_EmpI
    root.filename=filedialog.askopenfilename(initialdir='d:/',title='Select Image',filetypes=(("png files",".png"),("all files","*.*"))) #declare type of file
...
Ok_butt = Button(root, text='OK', fg='black', bg='azure1', width=20, height=1, )
